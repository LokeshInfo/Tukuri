...
import com.grocery_vendor.util.CustomVolleyJsonArrayRequest;
import com.grocery_vendor.util.JSONParser;
import com.grocery_vendor.util.NameValuePair;
import com.grocery_vendor.util.Session_management;
import com.grocery_vendor.util.Utility;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_pro_edit) {
            ...
            if (!TextUtils.isEmpty(getpincode)) {
                ...
                com.grocery_vendor.Fragment fm = new Socity_fragment();
