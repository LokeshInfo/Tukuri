...
import com.ics.android_tukuri.Fragment.Show_pro_detail_fragment;
import com.ics.android_tukuri.Model.Product_model;
...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView tv_title, tv_price, tv_total, tv_contetiy, tv_add, mrpPrice, dtx1, dtx2, d1, d2, dd1 ,dd2, tv_outofstock;
        public ImageView iv_logo, iv_plus, iv_minus, iv_remove;
        public CheckBox ch1, ch2;

        public MyViewHolder(View view) {
            super(view);
            tv_outofstock = (TextView) view.findViewById(R.id.tv_out_of_stock);
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.iv_subcat_plus) {
                ...
                if ( modelList.get(position).getIn_stock().equals("1")) {
                    ...
                    } else {                       dbcart.removeItemFromCart(map.get("product_id"));
                        tv_add.setText(context.getResources().getString(R.string.tv_pro_add));                 }
                    Double items = Double.parseDouble(dbcart.getInCartItemQty(map.get("product_id")));
                    Double price = Double.parseDouble(map.get("price"));

                    tv_total.setText("" + price * items);
                    ((com.ics.android_tukuri.MainActivity) context).setCartCounter("" + dbcart.getCartCount());
                }else{    Toast.makeText(context, "Sorry, Product is Out of Stock...", Toast.LENGTH_SHORT).show();      }
