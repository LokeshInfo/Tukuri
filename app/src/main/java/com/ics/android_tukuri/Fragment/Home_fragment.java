...
import com.ics.android_tukuri.Adapter.DealsAdapter;
import com.ics.android_tukuri.Adapter.Home_adapter;
import com.ics.android_tukuri.Adapter.HorizontalAdapter;
import com.ics.android_tukuri.Adapter.OfferAdapter;
import com.ics.android_tukuri.Adapter.RecyclerViewHorizontalListAdapter;
import com.ics.android_tukuri.Config.BaseURL;
import com.ics.android_tukuri.Model.Category_model;
import com.ics.android_tukuri.Model.Data;
import com.ics.android_tukuri.Model.DealsModel;
import com.ics.android_tukuri.Model.Grocery;
...
import com.ics.android_tukuri.HttpHandler;
...
public class Home_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.android_tukuri.MainActivity) getActivity()).set_style_Title(""+getActivity().getResources().getString(R.string.app_name));
        ((com.ics.android_tukuri.MainActivity) getActivity()).updateHeader();
...
//        rv_items.setLayoutManager(gridLayoutManager);
        ...
        if (ConnectivityReceiver.isConnected()) {
            ...
            new GetAPPupdate_status().execute();
        } else {
            Toast.makeText(getActivity(), "No Internet", Toast.LENGTH_SHORT).show();
        }
...
//*****************************************************************************************************
    ...
    private void makeGetSliderRequest() {
                        ...
                        try {
                           ...
                           listarray = new ArrayList<>();
                            ...
                            for(int i = 0; i<listarray.size(); i++) {
                                ...
                                final int finalI = i;
                                defaultSliderView.image(listarray.get(i).get("slider_image"))
                                        .setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                                            @Override
                                            public void onSliderClick(BaseSliderView slider) {
                                                if (!listarray.get(finalI).get("slider_url").matches("")){
                                                    Intent viewIntent =
                                                            new Intent("android.intent.action.VIEW",
                                                                    Uri.parse(listarray.get(finalI).get("slider_url")));
        ...
        com.ics.android_tukuri.AppController.getInstance().addToRequestQueue(req);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_search:
              /*  com.ics.android_tukuri.Fragment fm = new Search_fragment();
                FragmentManager fragmentManager = getFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.contentPanel, fm)
                        .addToBackStack(null).commit();
                return false;*/
        ...
        protected void onPostExecute(String output) {
            if (output == null) {
                ...
                try {
                    ...
                    offerlist.setLayoutManager(new GridLayoutManager(getActivity(), 2, GridLayoutManager.VERTICAL, false));
        ...
        protected void onPostExecute(String output) {
            if (output == null) {
                ...
                try {
                    ...
                    dealsview.setLayoutManager(new GridLayoutManager(getActivity(), 3, GridLayoutManager.VERTICAL, false));
    ...
    class GetAPPupdate_status extends AsyncTask<String, String, String> {
        String output = "";
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                server_url = BaseURL.UPDATE_APP;
            } catch (Exception e) {
                e.printStackTrace();
            }
            Log.e("sever_url>>>>>>>>>","UPDATE ..."+ server_url);
            output = HttpHandler.makeServiceCall(server_url);
            //   Log.e("getcomment_url", output);
            System.out.println("UPDATE app API  " + output);
            return output;
        }
        ...
        protected void onPostExecute(String output) {
            if (output == null) {
                ...
                try {
                    ...
                    Boolean bl = jsonob.getBoolean("responce");
                    if (bl){
    ...
    private void dialog_update_App() {
        final Dialog dialog = new Dialog(getActivity());
//            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
        dialog.setContentView(R.layout.dialog_uppdate_app);
        ...
        Button b_update = dialog.findViewById(R.id.btn_update);
        ...
        Button b_cancel = dialog.findViewById(R.id.btn_cancel);
