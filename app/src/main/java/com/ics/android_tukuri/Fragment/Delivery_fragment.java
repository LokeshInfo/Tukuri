...
import com.ics.android_tukuri.Adapter.Delivery_get_address_adapter;
import com.ics.android_tukuri.Config.BaseURL;
import com.ics.android_tukuri.Model.Delivery_address_model;
...
public class Delivery_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.android_tukuri.MainActivity) getActivity()).setTitle(getResources().getString(R.string.delivery));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        //RecyclerView.com.ics.android_tukuri.Adapter adapter1 = new Delivery_get_address_adapter(delivery_address_modelList);
