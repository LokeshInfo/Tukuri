...
import com.ics.android_tukuri.Adapter.My_order_detail_adapter;
import com.ics.android_tukuri.Config.BaseURL;
import com.ics.android_tukuri.Model.My_order_detail_model;
...
public class My_order_detail_fragment extends Fragment {
    ...
    private void makeGetOrderDetailRequest(String sale_id) {
        ...
        com.ics.android_tukuri.AppController.getInstance().addToRequestQueue(jsonObjReq, tag_json_obj);
