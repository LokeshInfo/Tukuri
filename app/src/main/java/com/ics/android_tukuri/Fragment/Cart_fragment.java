...
import com.ics.android_tukuri.Adapter.Cart_adapter;
...
import com.ics.android_tukuri.LoginActivity;
...
public class Cart_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.ics.android_tukuri.MainActivity) getActivity()).setTitle(getResources().getString(R.string.tv_cart_title));
