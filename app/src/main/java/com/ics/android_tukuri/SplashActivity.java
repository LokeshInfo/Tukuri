...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // app_name = (TextView)findViewById(R.id.app_name);
        ...
        sessionManagement = new Session_management(com.ics.android_tukuri.SplashActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == MY_PERMISSIONS_REQUEST_WRITE_FIELS) {
            if (grantResults.length > 0
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(com.ics.android_tukuri.SplashActivity.this);
    ...
    public void go_next() {
           ...
           if(sessionManagement.isLoggedIn()) {
            ...
            Intent startmain = new Intent(com.ics.android_tukuri.SplashActivity.this, MainActivity.class);
    ...
    public void openPermissionScreen() {
        ...
        Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS,
                Uri.fromParts("package", com.ics.android_tukuri.SplashActivity.this.getPackageName(), null));
